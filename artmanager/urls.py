...
#    ),
    ...
    url(r'^pending/(?P<pending_id>[0-9]+)/update/$', artmanager_views.UpdatePendingView.as_view(), name='update-pending'),
    url(r'^pending/(?P<pending_id>[0-9]+)/delete/$', artmanager_views.DeletePendingView.as_view(), name='delete-pending'),
